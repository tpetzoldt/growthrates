...
It can be a good idea, to use a nonparametric approach like the smoothing spline 
...
Describing the observed dependency can again be described with parametric or nonparametric
a functional response curves, which may then be done directly in R or by using a specialized
