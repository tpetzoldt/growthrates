...
$$\frac{dy_a}{dt} =   k_w \cdot y_i + \mu \cdot 
  y_a \cdot \left(1 - \frac{K}{y_a + y_i} \right)$$

with amount of total organisms $y = y_i + y_a$, the parameters adaption rate $k_w$, 
intrinsic growth rate $\mu$, carrying capacity $K$. The initial abundance (normally $y_0$) 
...
``consumes'' parts of the effect because of interdependency between `h0`and `mu`:
