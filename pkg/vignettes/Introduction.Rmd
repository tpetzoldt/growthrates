...
**Please note:** This document reflects work in progress and will be updated from time to time. The most recent copy can be downloaded from https://github.com/tpetzoldt/growthrates/blob/master/doc/Introduction.pdf
...
2. Fitting of linear models to the period of exponential growth using
  the ``growth rates made easy method'' of @Hall2013 ,
...
and in addition to the original method of @Hall2013 it is also possible to
...
Fiting multiple data sets at once is possible with functions
...
strains with the spline fit and the Baranyi model:
...
may be done by using a specialized package for dose-response curves,
